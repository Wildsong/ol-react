...
export {default as BingMaps} from './tile-bingmaps'
export {default as OSM} from './tile-osm'
export {default as Stamen} from './tile-stamen'
export {default as TileArcGISRest} from './tile-arcgisrest'
